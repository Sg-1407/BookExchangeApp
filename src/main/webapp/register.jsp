					...
					<div class="card-body">
						...
						<form action="register" method="post" id="register" novalidate>
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Enter Full Name <span
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Phone No <span
									class="text-danger">*</span></label> <input type="number"
									class="form-control" name="phno" required>
							</div>
							...
							<div class="form-check">
								<input type="checkbox" class="form-check-input" name="check"
									...
									for="exampleCheck1" required>Agree terms & Condition <span
